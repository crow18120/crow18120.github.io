import $ from "jquery";
import active_btn_dot_file_item from "./file-item";
...
inputEmail.oninvalid = function (event) {
  if (inputEmail.validity.valueMissing)
    ...
    inputEmail.validity.typeMismatch ||
    inputEmail.validity.patternMismatch
  )
...
nameManga.oninvalid = function (e) {
  if (nameManga.validity.valueMissing)
    e.target.setCustomValidity("Vui lòng nhập Tên truyện.");
